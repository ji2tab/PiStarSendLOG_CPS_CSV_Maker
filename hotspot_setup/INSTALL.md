...
4. ネットワーク表示名・英数半角10文字まで (例: TGIF168 / XLX834Z): TGIF168
```

> ネットワーク表示名は英数字・スペースのみ、10文字以内で入力してください。  
> NW（ネットワーク経由）の交信時にWebサイト上に表示されます。
...
curl -i -X POST "https://jj2yyk.forums.gr.jp/wp-json/hotspot/ingest" \
  ...
  -d '{"node":"yyk-tgif","callsign":"JJ2ZAR","net_label":"TGIF168","dmr":{"src":"NETWORK","dst":"168","slot":2}}'
```
